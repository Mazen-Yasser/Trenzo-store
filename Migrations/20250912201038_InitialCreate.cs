        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingAddressLine2 = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VariantInfo = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Description", "ImageUrl", "IsActive", "Name", "SortOrder" },
                values: new object[,]
                {
                    { 1, "Clothing for men", "", true, "Men's Clothing", 1 },
                    { 2, "Clothing for women", "", true, "Women's Clothing", 2 },
                    { 3, "Fashion accessories", "", true, "Accessories", 3 },
                    { 4, "Footwear for all", "", true, "Shoes", 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "A comfortable and versatile white t-shirt made from 100% cotton. Perfect for casual wear or layering.", true, true, "Classic White T-Shirt", 19.99m, "TSH-WHT-001", "Comfortable 100% cotton white t-shirt", 100 },
                    { 2, 1, 99.99m, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Classic blue denim jeans with a comfortable fit. Made from premium denim fabric with a modern cut.", true, true, "Blue Denim Jeans", 79.99m, "JNS-BLU-001", "Classic blue denim jeans", 50 },
                    { 3, 2, null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "An elegant black dress perfect for formal occasions. Made from high-quality fabric with a flattering silhouette.", true, true, "Elegant Black Dress", 129.99m, "DRS-BLK-001", "Elegant black formal dress", 25 },
                    { 4, 3, null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "A stylish leather handbag with multiple compartments. Perfect for everyday use or special occasions.", true, false, "Leather Handbag", 89.99m, "BAG-LTH-001", "Stylish leather handbag", 30 }
                });
